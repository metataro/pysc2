...
_FUNCTIONS = [
    ...
    Function.ability(558, "HoldPosition_Battlecruiser_quick", cmd_quick, 3778, 18),
    Function.ability(559, "HoldPosition_Hold_quick", cmd_quick, 379, 18),
    ...
    Function.ability(561, "Move_Battlecruiser_screen", cmd_screen, 3776, 16),
    Function.ability(562, "Move_Battlecruiser_minimap", cmd_minimap, 3776, 16),
    Function.ability(563, "Move_Move_screen", cmd_screen, 3794, 16),
    Function.ability(564, "Move_Move_minimap", cmd_minimap, 3794, 16),
    Function.ability(333, "Patrol_screen", cmd_screen, 17),
    Function.ability(334, "Patrol_minimap", cmd_minimap, 17),
    Function.ability(565, "Patrol_Battlecruiser_screen", cmd_screen, 3777, 17),
    Function.ability(566, "Patrol_Battlecruiser_minimap", cmd_minimap, 3777, 17),
    Function.ability(567, "Patrol_Patrol_screen", cmd_screen, 3795, 17),
    Function.ability(568, "Patrol_Patrol_minimap", cmd_minimap, 3795, 17),
...
_RAW_FUNCTIONS = [
    ...
    Function.raw_ability(17, "HoldPosition_quick", raw_cmd, 18),
    Function.raw_ability(542, "HoldPosition_Battlecruiser_quick", raw_cmd, 3778, 18),
    Function.raw_ability(543, "HoldPosition_Hold_quick", raw_cmd, 3793, 18),
    ...
    Function.raw_ability(13, "Move_pt", raw_cmd_pt, 16),
    Function.raw_ability(14, "Move_unit", raw_cmd_unit, 16),
    Function.raw_ability(545, "Move_Battlecruiser_pt", raw_cmd_pt, 3776, 16),
    Function.raw_ability(546, "Move_Battlecruiser_unit", raw_cmd_unit, 3776, 16),
    Function.raw_ability(547, "Move_Move_pt", raw_cmd_pt, 3794, 16),
    Function.raw_ability(548, "Move_Move_unit", raw_cmd_unit, 3794, 16),
    Function.raw_ability(15, "Patrol_pt", raw_cmd_pt, 17),
    Function.raw_ability(16, "Patrol_unit", raw_cmd_unit, 17),
    Function.raw_ability(549, "Patrol_Battlecruiser_pt", raw_cmd_pt, 3777, 17),
    Function.raw_ability(550, "Patrol_Battlecruiser_unit", raw_cmd_unit, 3777, 17),
    Function.raw_ability(551, "Patrol_Patrol_pt", raw_cmd_pt, 3795, 17),
    Function.raw_ability(552, "Patrol_Patrol_unit", raw_cmd_unit, 3795, 17),
